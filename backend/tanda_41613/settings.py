"""
Django settings for tanda_41613 project.
...
WSGI_APPLICATION = 'tanda_41613.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tanda_41613 API",
    "DESCRIPTION": "API documentation for tanda_41613 App",
    "VERSION": "v1",
}
